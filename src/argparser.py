...
def run_argparser():
    ...
    parser.add_argument("--sender", required=False, help="(RSA, ECC only)The \"sender\" name. (e.g. alice, bob)", default="")
    parser.add_argument("--receiver", required=False, help="(RSA, ECC only)The \"receiver\" name. (e.g. alice, bob)", default="")
